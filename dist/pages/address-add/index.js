...
var commonCityData = require('../../static/data/citydata.js');
//获取应用实例
var app = getApp();
...
exports.default = Page({
  ...
  initCityData: function initCityData(level, obj) {
    if (level == 1) {
      var pinkArray = [];
  ...
  bindPickerProvinceChange: function bindPickerProvinceChange(event) {
  ...
  bindPickerCityChange: function bindPickerCityChange(event) {
  ...
  bindPickerChange: function bindPickerChange(event) {
  ...
  setDBSaveAddressId: function setDBSaveAddressId(data) {
    var retSelIdx = 0;
    for (var i = 0; i < commonCityData.cityData.length; i++) {
